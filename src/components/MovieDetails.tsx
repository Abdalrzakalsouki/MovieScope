...
import { Credits, Cast, Crew, Movie } from "../Interfaces/interface.tsx";
...
const MovieDetails = ({ movie }: { movie: Movie }) => {
  ...
  const { data, loading, error } = useFetch<Credits>(creditURL, key);
  const [chosedCasting, setChosedCasting] = useState<
    Cast[] | Crew[] | undefined
  >(data?.cast);
              ...
              <div css={container}>
                ...
                <Grid container>
                  ...
                  >
                    ...
                    <div>
                      <Typography
                        sx={{ paddingBlock: "10px", fontSize: "25px" }}
                      >
                        Overview
                ...
                <div>
                  <Container sx={{ paddingBlock: "2rem" }}>
                    <ul css={listContainer}>
                      <StyledItem onClick={() => setChosedCasting(data.cast)}>
                        Cast
                      </StyledItem>
                      <StyledItem onClick={() => setChosedCasting(data.crew)}>
                        Crew
                      </StyledItem>
                    </ul>
                  </Container>
